...
from caption_policy.prompt_generator import SubjectPolicy, ScenePolicy, SubjectMotionPolicy, SpatialPolicy, CameraPolicy
...
def main():
    ...
    st.subheader("Current Prompt (Please Give Zhiqiu Feedback!)")
    ...
    if st.session_state.current_step == 0:
        st.write("##### 麻烦试着用这个prompt来给Gemini-2/ChatGPT/Taiser做Pre-caption！有什么反馈可以和Zhiqiu说！")

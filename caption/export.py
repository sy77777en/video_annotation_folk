...
def export_videos_by_status(video_urls, configs, data_manager, app_config, only_reviewed=False, ignore_errors=False):
    ...
    for video_url in video_urls:
        video_id = data_manager.get_video_id(video_url)  # get_video_id is a static method of DataManager
...
def main():
    ...
    print(f"🏗️  Using NEW modular structure (DataManager handles all core functions)")

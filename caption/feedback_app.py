...
def main():
    ...
    if st.session_state.current_step == 0:
        ...
        num_lines = max(10, len(pre_caption_prompt) // 120)  # Assuming ~120 characters per line
        ...
        if score:
            ...
            st.session_state.feedback_data = {
                ...
                "gpt_feedback_llm": None,  # TODO: New
                "gpt_feedback_prompt": None,  # TODO: New
                "gpt_feedback": None,
                "feedback_rating": None,
                "feedback_rating_score": None,
                "final_feedback": None,
                "gpt_caption_llm": None,  # TODO: New
                "gpt_caption_prompt": None, # TODO: New
                "gpt_caption": None,
                "caption_rating": None,
    ...
    # Step 1: Rate GPT's feedback and optionally provide corrected feedback
        ...
        if st.session_state.get("feedback_submitted", False):
            # st.session_state.feedback_submitted = False  # Reset flag # TODO: Check if this is needed or can be removed

...
# Process new overlapping videos from the September 12 dataset
python caption/process_new_videos.py \
    --new-dir "caption/video_urls/20250912_setup_and_motion" \
    --valid-filename "overlap_all_1046.json" \
    --invalid-filename "caption/video_urls/20250912_setup_and_motion/overlap_invalid.json" \
    --batch-files \

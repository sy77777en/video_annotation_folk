...
# Process new non-overlapping videos from the September 12 dataset  
python caption/process_new_videos.py \
    --new-dir "caption/video_urls/20250912_setup_and_motion" \
    --valid-filename "nonoverlap_all_1513.json" \
    --invalid-filename "caption/video_urls/20250912_setup_and_motion/nonoverlap_invalid.json" \
    --batch-files \

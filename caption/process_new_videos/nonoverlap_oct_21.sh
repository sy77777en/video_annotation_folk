...
# Process new non-overlapping videos from October 21 dataset
python caption/process_new_videos.py \
    --new-dir "caption/video_urls/20251021_ground_and_setup_folder" \
    --valid-filename "nonoverlap_all_2368.json" \
    --invalid-filename-nonoverlap "caption/video_urls/20251021_ground_and_setup_folder/nonoverlap_invalid.json" \
    --batch-files \
